  ...
  new FacebookStrategy(
    {
      ...
      clientSecret: '',
      // Your callback URL
      callbackURL: 'https://legendary-trout-7wjvpqwgp54fr75g-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://legendary-trout-7wjvpqwgp54fr75g-3000.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://legendary-trout-7wjvpqwgp54fr75g-3000.app.github.dev/', 
}));
